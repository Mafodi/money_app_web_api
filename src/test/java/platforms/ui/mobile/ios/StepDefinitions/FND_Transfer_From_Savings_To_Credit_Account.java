...
public class FND_Transfer_From_Savings_To_Credit_Account extends DriverFactory {
    ...
    public void tscr_userIsOnTheTransferScreenIosApp() throws Throwable {
        transferFlow.Navigate_To_Transfer_Screen();
    }

    @When("^Tscr_User enters amount to transfer ios app$")
    public void tscr_userEntersAmountToTransferIosApp() throws InterruptedException {
        Thread.sleep(2000);
    ...
    public void tscr_userSelectsFromAccountIosApp() throws InterruptedException {
    ...
    public void tscr_userSelectsToAccountIosApp() throws InterruptedException {
        basepage.horizontalSwipeByPercentage(0.6,0.1,0.3);
        basepage.horizontalSwipeByPercentage(0.6,0.1,0.3);
    }

    @Then("^Tscr_User Clicking on next should take user to review transfer screen ios app$")
    public void tscr_userClickingOnNextShouldTakeUserToReviewTransferScreenIosApp() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public void tscr_userShouldBeAbleToMakeTransferSuccessfullyIosApp() throws InterruptedException {
        Thread.sleep(2000);
