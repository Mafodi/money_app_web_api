Feature: Non Staff Consolidate Weekly

  @PLConOfferWKLY @fullFlow
...
#And user authorises the debicheck
    ...
    Examples:
      ...
      | GhostCard2 | Testing123* | Test WKLY Pass:Consolidation loan. Up to R245 600.00 |     yes     |  no    |        yes             |Salary date   |35000    |interested |
