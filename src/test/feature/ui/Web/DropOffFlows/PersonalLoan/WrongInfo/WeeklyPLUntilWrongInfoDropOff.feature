Feature: Non Staff Personal Loan Weekly with wrong infomation

@PLOfferWKLYOwnInsurance @WrongInfo
...
| GhostCard2 | Testing123* | Test WKLY Pass:Personal loan. Up to R182 800.00 |     yes     | monthly income |
