Feature:Non Staff Personal Loan Monthly wrong infomation

  @PLOfferMNTHLYWrongInfo @WrongInfo
  Scenario Outline: as a user i want to take up an offer
    ...
    Examples:
      ...
      | GhostCard2  | Testing123* | Test MNTHLY Pass:Personal loan. Up to R250 000.00 |     no     |monthly income |