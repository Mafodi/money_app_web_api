...
public class FND_Make_A_Weekly_Recurring_Future_Dated_Payment_from_Current_to_Investment extends DriverFactory {
    ...
    public FND_Make_A_Weekly_Recurring_Future_Dated_Payment_from_Current_to_Investment(){}

    @Given("^FD_Weekly_User_IA is on the Payment screen$")
    public void fd_weekly_user_iaIsOnThePaymentScreen() throws Throwable {
        paymentFlow.Navigate_To_Payment_Screen();
    }

    @When("^FD_Weekly_User_IA navigates to Single Payment screen$")
    public void fd_weekly_user_iaNavigatesToSinglePaymentScreen() {
        payScreen.Transact_single_pay.click();
        log.info("single payment selected");
    }

    @And("^FD_Weekly_User_IA selects recipients icon$")
    public void fd_weekly_user_iaSelectsRecipientsIcon() {
        payScreen.Transact_Pay_Beneficiary_list_icon.click();
    }

    @And("^FD_Weekly_User_IA should be able to search \"([^\"]*)\" and select$")
    public void fd_weekly_user_iaShouldBeAbleToSearchAndSelect(String recipientsname) throws Throwable {
        paymentFlow.Select_Beneficiary(recipientsname);
    }

    @And("^FD_Weekly_User_IA selects a future date for payment$")
    public void fd_weekly_user_iaSelectsAFutureDateForPayment() throws InterruptedException {
    ...
    public void fd_weekly_user_iaSelectsRepeatWeekly() throws InterruptedException {
    ...
    public void fd_weekly_user_iaShouldBeAbleToMakePaymentSuccessfully() throws InterruptedException {
        Thread.sleep(2000);
