Feature: PL_Weekly_E2E_Flow
Description: PL_Weekly_E2E_Flow

@PL_Weekly_E2E_MoreNotification_IOS @Regression_PL_IOS
Scenario Outline: PL_Weekly_E2E_Flow
...
|PLOffer                                                                                                                                                                               |
|Test WKLY Pass:Personal loan. 10% interest rate. Loan up to R50 000.00. Money in your account with a few simple clicks. |
