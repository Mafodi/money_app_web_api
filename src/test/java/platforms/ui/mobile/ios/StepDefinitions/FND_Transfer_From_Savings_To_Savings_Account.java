...
public class FND_Transfer_From_Savings_To_Savings_Account extends DriverFactory {
    ...
    public void tss_userIsOnTheTransferScreenIosApp() throws Throwable {
        transferFlow.Navigate_To_Transfer_Screen();
    }

    @When("^Tss_User enters amount to transfer ios app$")
    public void tss_userEntersAmountToTransferIosApp() throws InterruptedException {
        Thread.sleep(2000);
    ...
    public void tss_userSelectsFromAccountIosApp() throws InterruptedException {
    ...
    public void tss_userSelectsToAccountIosApp() {
        basepage.horizontalSwipeByPercentage(0.6,0.1,0.3);
        basepage.horizontalSwipeByPercentage(0.6,0.1,0.3);
        basepage.horizontalSwipeByPercentage(0.6,0.1,0.3);
    }
    ...
    public void tss_userClickingOnNextShouldTakeUserToReviewTransferScreenIosApp() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public void tss_userShouldBeAbleToMakeTransferSuccessfullyIosApp() throws InterruptedException {
        Thread.sleep(2000);
