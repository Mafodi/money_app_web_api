...
public class FND_Make_A_Payment_Beneficiary_Payment_from_Current_to_Current_Account_nedbank extends DriverFactory {
    ...
    @Given("^PEM_User_CA is on the Payment screen ios app$")
    public void pem_user_caIsOnThePaymentScreenIosApp() throws Throwable {
        paymentFlow.Navigate_To_Payment_Screen();
    }

    @When("^PEM_Verify_CA navigates to Single Payment screen ios app$")
    public void pem_verify_caNavigatesToSinglePaymentScreenIosApp() {
        payScreen.Transact_single_pay.click();
        log.info("single payment selected");
    }

    @And("^PEM_Click_CA selects recipients icon ios app$")
    public void pem_click_caSelectsRecipientsIconIosApp() {
        payScreen.Transact_Pay_Beneficiary_list_icon.click();
    }

    @And("^PEM_Click_CA should be able to search \"([^\"]*)\" and select ios app$")
    public void pem_click_caShouldBeAbleToSearchAndSelectIosApp(String recipientsname) throws Throwable {
        Thread.sleep(2000);
    ...
    public void pem_click_caClickingOnNextShouldTakeMeToNextScreenIosApp() throws InterruptedException {
        paymentFlow.Process_Payment_to_Beneficiary();
    }

    @And("^PEM_Click_CA should be able to make payment successfully ios app$")
    public void pem_click_caShouldBeAbleToMakePaymentSuccessfullyIosApp() {
