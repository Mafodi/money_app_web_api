@notifications
Feature: Create app notifications
...
#    * def createSNotification = read('In-App-Notifications/createSinglePayload.json')
  ...
  "notification": {
    ...
    Examples:
      ...
      | 6aa93f2e-2d66-48dd-b2c6-b773f16283ac | X3yB3vD8rG6cT3gK7wK1jE6kL4lI0tG1fK2bR1hI5qN4qM0oK4 | 5ff8262a14794b03a2e11e75ae777db4 | Walter       | 414887048473     | CIS                  | 2020-08-01T11:01:19 | 2020-08-01T11:01:19 |
...
",
  ...
  @back-office-app
  Scenario Outline: Broadcast notifications
    Given url InApp_BackOffice_BaseUrl
    And path 'notifications/broadcasts'
    And  header Content-type = 'Application/Json'
    And header Accept-Encoding = 'Application/Json'
    And header x-ibm-client-id = '<ibmClientId>'
    And header x-ibm-client-secret = '<ibmClientSecret>'
    ...
    When def createAppNotification =
     """
        {
      "notification": {
      "backOfficeNotificationId": "Broadcast_#(uuid)",
       "notificationType": "MKT",
       "topic": "MoneyApp_Enrolled_Users_Android",
      "displayCategory": "Offers",
       "displaySubCategory": "Broadcast",
       "heading": "Card management made easy",
      "subHeading": "Did you know you can enable 'tap and go' on the app?",
      "body": "<p>You can manage your cards easily on the app. Enable 'tap and go' and online purchases. If you have misplaced your card, you can freeze it on the app immediately. If you find your card, you can unfreeze it again on the app. <p>Go to the 'Cards' tab on the app and follow the easy steps. ",
      "backOfficeNotificationDate": "2020-01-21T13:58:12.7908924+02:00",
      "activeExpiryDate": "2020-06-20T11:01:19",
     "deviceExpiryDate": "2020-06-20T11:01:19",
     "responsePriority": 2,
     "isTrackable": false,
     "mustTrackFirstRead": false,
      "mustTrackAllReads": false,
      "mustTrackDismiss": false,
     "allowMultipleResponses": false,
     "allowAnonymous": false,
...
#    Examples:
#      | ibmClientId                          | ibmClientSecret                                    | backOfficeToken                  | backOfficeId | clientIdentifier | clientIdentifierType | activeExpiryDate    | deviceExpiryDate    |
#      | 6aa93f2e-2d66-48dd-b2c6-b773f16283ac | X3yB3vD8rG6cT3gK7wK1jE6kL4lI0tG1fK2bR1hI5qN4qM0oK4 | 5ff8262a14794b03a2e11e75ae777db4 | Walter       | 414429120356    | CIS                  | 2020-08-01T11:01:19 | 2020-08-01T11:01:19 |
