Feature: Verify the UnAuthOpt_Out_Mode flow

  @unauth_opt_out_nonqmatic  @AllScenarios_UnauthOptout
  Scenario Outline: Verification of Branch Details flow in UnAuth opt out for non qmatic branch
  ...
  @unauth_opt_out_qmatic  @AllScenarios_UnauthOptout
  Scenario Outline: Verification of Branch Details flow in UnAuth opt out for QMatic branch
    Given user launches iOS money app
    When user deny location services
    And ios user select continue button
    And ios user select pre login more button
  ...
  @unauth_opt_out_AdvancedFilter @AllScenarios_UnauthOptout
  Scenario Outline: Verification of Advanced filter flow in UnAuth opt out
    Given user launches iOS money app
    When user deny location services
    And ios user select continue button
    And ios user select pre login more button
  ...
  @unauth_opt_out_ATMFlow @AllScenarios_UnauthOptout
  Scenario Outline: Verification of ATM flow in UnAuth opt out
    Given user launches iOS money app
    When user deny location services
    And ios user select continue button
    And ios user select pre login more button
  ...
  @SQ_UnAuthOpt_out_Mode_AdvancedFilterError_iOS  @AllScenarios_UnauthOptout
  ...
  @SQ_UnAuthOpt_Out_Mode_AutosuggestionCheck_iOS  @AllScenarios_UnauthOptout
  Scenario Outline: Verification of autosuggestion functionality check while searching branch in unauthenticated mode
    Given user launches iOS money app
    When user deny location services
    And ios user select continue button
    And ios user select pre login more button
  ...
  @SQ_UnAuthOpt_Out_Mode_ATMAutosuggestionCheck_iOS @AllScenarios_UnauthOptout
  ...
  @SQ_UnAuthOpt_Out_Mode_BranchValidSearch_iOS @AllScenarios_UnauthOptout
  ...
  @SQ_UnAuthOpt_Out_Mode_ATMValidSearch_iOS @AllScenarios_UnauthOptout
  ...
  @SQ_UnAuthOpt_Out_Mode_BranchClearSearchButton_iOS @AllScenarios_UnauthOptout
  ...
  @SQ_UnAuthOpt_Out_Mode_ClearFilter_iOS @AllScenarios_UnauthOptout
  ...
  @SQ_UnAuthOpt_Out_Mode_MultiServiceFilter_iOS @AllScenarios_UnauthOptout
  ...
  @SQ_UnAuthOpt_Out_Mode_MultiServiceFilterClearAll_iOS @AllScenarios_UnauthOptout
  ...
  @SQ_UnAuthOpt_Out_Mode_MultiServiceFilterError_iOS @AllScenarios_UnauthOptout
