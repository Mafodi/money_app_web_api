Feature:Non Staff Personal Loan Monthly Bureau

  @PLOfferMNTHLYBureau @AllBureau
  Scenario Outline: as a user i want to take up an offer
    ...
    Examples:
      ...
      | GhostStaff4  | Testing123* | Test MNTHLY Pass:Personal loan. Up to R250 000.00 |     yes     |  no    |        yes             |Salary date   |35000    |