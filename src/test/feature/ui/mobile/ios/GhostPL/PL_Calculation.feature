...
Then User_IOS enters username and password"<UserName>""<Password>"
...
And User_IOS checks the "<upper>" and "<lower>" limit
And User_IOS checks the heading"<upperterms>""<Fixedinterestrate>"
And User_IOS checks default amount value,default slider value,default terms value"<upper>" "<upperslider>""<upperterms>"
And User_IOS checks defaultmonthlyrepayment "<defaultmonthlyrepayment>"
#And User_IOS enters amount manually "<manualamount>"
And User_IOS clicks on the terms tab
And User_IOS clicks on back button on terms screen
And User_IOS clicks on the terms tab
And User_IOS checks all the terms are displayed"<allterms>"
And User_IOS selects a different "<terms>"
And User_IOS checks the heading"<terms>""<Fixedinterestrate>"
And User_IOS scrolls your offer screen to bottom
And User_IOS clicks on recaculate monthly payment button
And User_IOS checks NewMonthlyRepayment"<newmonthlyrepayment>"
And User_IOS scrolls your offer screen to bottom
And User_IOS clicks confirm button on YourOffer screen
And User_IOS checks the calculations on review screen"<Creditlifeinsurance>""<Servicefee>""<Baserepayment>""<Totalmonthlyrepayment>""<Amountwillpay>""<FixedinterestrateReview>""<Numberofinstalments>""<Initiationfee>""<Creditcostmultiple>""<Totalloanamount>""<Totalyoupay>"
