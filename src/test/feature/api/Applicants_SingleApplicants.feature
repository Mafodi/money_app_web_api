Feature: As a user I should be able to get applicants information
  ...
  Scenario Outline: Submit Pre-Aproval Request for a Single Applicant
    ...
    Examples:
      ...
      | 1        | 750000.00      | 1      | 20       | 50000.00      | true             | 1        | 8901230052087 | John     | Johnson | M             | 0826741820   | azeezs@nedbank.co.za | 80000.00           | 55000.00         | 1000.00     | 1000.00             | 1000.00         | 01           | true             | false          | New Loan    | 01          | New Loan           | 1000000.00    |                       | 1000000.0 | ApprovedOfferResponse |
  ...
  @regression
  @UID8761-253
  Scenario Outline: Update applicants loan details
    Given def offerId = read('TokenStore/OfferId.txt')
    And def clientId = read('TokenStore/Applicants.txt')
    ...
    """
      {
        ...
        "howPayInitiationFee": "<howPayInitiationFee>",
        ...
        "valuationContactPerson": "<valuationContactPerson>",
        "valuationFirstName": "<valuationFirstName>",
        "valuationSurname": "<valuationSurname>",
        "valuationContactNumber": "<valuationContactNumber>",
        "valuationAltContactNumber": "<valuationAltContactNumber>",
        "loanType": "<loanType>",
        "loanReason": "<loanReason>",
        "existingLoanAccount": "<existingLoanAccount>"
      }
    """
    ...
    And print responseJson
    And match response.data != ''
    And match response.data.amountToRegister == <amountToRegister>
    And match response.data.howPayInitiationFee == '<howPayInitiationFee>'
    And match response.data.propertyTitle == '<propertyTitle>'
    And match response.data.propertyUsage == '<propertyUsage>'
    And match response.data.address.street == '<street>'
    And match response.data.valuationContactPerson == '<valuationContactPerson>'
    And match response.data.valuationContactNumber == '<valuationContactNumber>'

    Examples:
      | amountToRegister | howPayInitiationFee | propertyTitle | propertyUsage | sellerIdNumber | street            | complex              | suburb   | town    | city         | province | country | postalCode | districtCouncil | municipality | suburbId | addressString                                                                 | streetType | matchLevel | streetNumber | valuationContactPerson | valuationFirstName | valuationSurname | valuationContactNumber | valuationAltContactNumber | loanType | loanReason | existingLoanAccount |
      | 1200555.20       | 1                   | 1             | 1             | 9001110011086  | 14 Riverside Road | Phoenix View Estate  | Noordwyk | Midrand | Johannesburg | Gauteng  | ZA      | 1687       | 06              | Tshwane      | 10       | 14 Riverside Road, Phoenix View Estate, Noordwyk, Midrand, Johannesburg, 1687 | Street     | 0          | 14           | A                      | Misty              | Bleu             | 0762583164             | 0796841530                | 1        | 1          |                     |
      | 1200555.20       | 1                   | 3             | 2             | 9001110011086  | 14 Riverside Road | Phoenix View Estate  | Noordwyk | Midrand | Johannesburg | Gauteng  | ZA      | 1687       | 06              | Tshwane      | 10       | 14 Riverside Road, Phoenix View Estate, Noordwyk, Midrand, Johannesburg, 1687 | Street     | 0          | 14           | A                      | Misty              | Bleu             | 0762583164             | 0796841530                | 1        | 1          |                     |
      | 1200555.20       | 1                   | 3             | 3             | 9001110011086  | 14 Riverside Road | Phoenix View Estate  | Noordwyk | Midrand | Johannesburg | Gauteng  | ZA      | 1687       | 06              | Tshwane      | 10       | 14 Riverside Road, Phoenix View Estate, Noordwyk, Midrand, Johannesburg, 1687 | Street     | 0          | 14           | A                      | Misty              | Bleu             | 0762583164             | 0796841530                | 1        | 1          |                     |
  ...
  Scenario Outline: Update applicants additional details to test for <scenarioName>
    ...
    And match response.data.sourceOfFundsDepositAndTransfer == '<sourceOfFundsDepositAndTransfer>'
    ...
    Examples:
      ...
      | true                          | loan       | 1000000         | 0           | FNB       | false                    | 0          | 0             |            |          | true            |  Phone           | 2000         | FNB        | false             |               |                    | false                |                  | false                        |                     | 1                               |                  | true               | benefit1       | false                     |                     | - Has anothe loan                  |
      | false                         |            | 0               | 0           |           | false                    | 0          | 0             |            |          | true            |  Phone           | 300          | FNB        | true              | 2014-05-01    | 2014-06-01         | false                |                  | false                        |                     | 2                               |                  | true               | benefit1       | false                     |                     | - Declared Insolvent               |
      | false                         |            | 0               | 0           |           | false                    | 0          | 0             |            |          | true            |  Phone           | 400          | FNB        | false             |               |                    | false                |                  | true                         | 4000                | 3                               |                  | true               | benefit1       | false                     |                     | - is Dependent Other Non Applicant |
      | false                         |            | 0               | 0           |           | false                    | 0          | 0             |            |          | false           |                  | 0            |            | false             |               |                    | false                |                  | true                         | 4000                | 4                               |                  | true               | benefit1       | false                     |                     | - Has relationship with seller     |
