Feature:Non Staff Personal Loan Monthly

  @PLOfferMNTHLY1 @fullFlow
...
#And user authorises the debicheck
    ...
    Examples:
      ...
      | GhostCard2  | Testing123* | Test MNTHLY Pass:Personal loan. Up to R250 000.00 |     yes     |  no    |        yes             |Salary date   |35000    |Furniture|glens@nedbank.co.za|interested |