...
public class FND_Make_A_Weekly_Recurring_Future_Dated_Payment_from_Current_to_CreditCard extends DriverFactory {
    ...
    public FND_Make_A_Weekly_Recurring_Future_Dated_Payment_from_Current_to_CreditCard(){}

    @Given("^FD_Weekly_User_CC is on the Payment screen$")
    public void fd_weekly_user_ccIsOnThePaymentScreen() throws Throwable {
        paymentFlow.Navigate_To_Payment_Screen();
    }

    @When("^FD_Weekly_User_CC navigates to Single Payment screen$")
    public void fd_weekly_user_ccNavigatesToSinglePaymentScreen() {
        payScreen.Transact_single_pay.click();
        log.info("single payment selected");
    }

    @And("^FD_Weekly_User_CC selects recipients icon$")
    public void fd_weekly_user_ccSelectsRecipientsIcon() {
        payScreen.Transact_Pay_Beneficiary_list_icon.click();
    }

    @And("^FD_Weekly_User_CC should be able to search \"([^\"]*)\" and select$")
    public void fd_weekly_user_ccShouldBeAbleToSearchAndSelect(String recipientsname) throws Throwable {
        paymentFlow.Select_Beneficiary(recipientsname);
    }

    @And("^FD_Weekly_User_CC selects a future date for payment$")
    public void fd_weekly_user_ccSelectsAFutureDateForPayment() throws InterruptedException {
    ...
    public void fd_weekly_user_ccSelectsRepeatWeekly() throws InterruptedException {
    ...
    public void fd_weekly_user_ccShouldBeAbleToMakePaymentSuccessfully() throws InterruptedException {
        Thread.sleep(2000);
