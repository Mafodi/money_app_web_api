...
public class FND_Transfer_From_Current_To_Current_Account extends DriverFactory {
    ...
    public void tcucu_userIsOnTheTransferScreen() throws Throwable {
        transferFlow.Navigate_To_Transfer_Screen();
    }

    @When("^TCuCu_User enters amount to transfer$")
    public void tcucu_userEntersAmountToTransfer() throws InterruptedException {
        Thread.sleep(2000);
        transferScreen.Transfer_amount.sendKeys("15555");
    }

    @And("^TCuCu_User selects from account$")
    public void tcucu_userSelectsFromAccount() throws InterruptedException {
        basepage.android_scroll_down(1);
        Thread.sleep(2000);
    }

    @And("^TCuCu_User selects to account$")
    public void tcucu_userSelectsToAccount() throws InterruptedException {
        try{
    ...
    public void tcucu_userClickingOnNextShouldTakeUserToReviewTransferScreen() throws InterruptedException {
        Thread.sleep(2000);
    ...
    public void tcucu_userShouldBeAbleToMakeTransferSuccessfully() {
