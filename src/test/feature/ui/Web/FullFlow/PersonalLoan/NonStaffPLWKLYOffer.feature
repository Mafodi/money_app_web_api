Feature: Non Staff Personal Loan Weekly

  @PLOfferWKLY @fullFlow
...
And user accepts or decline STL "<STLdecidion>"
    ...
    Examples:
      ...
      | GhostCard2 | Testing123* | Test WKLY Pass:Personal loan. Up to R182 800.00 |     yes     |  no    |        yes             |Salary date   |35000    |interested |
