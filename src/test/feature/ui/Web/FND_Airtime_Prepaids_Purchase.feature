...
Scenario Outline: Buy Prepaid Airtime
  ...
  Examples:
    ...
    |Jeznna	    |0836879512	|MTN		  |Airtime	|29			|			|1950479609	  |Mar Properties CC	  |DocJ		|			|			          |No	  |Done		|
    |Chrzis	    |0740033923	|CELL C		  |Airtime	|10		|			|			  |			  |Booking	|Fax		|0865948576			  |No	  |Done		|
    |Phizllip	    |0829988002	|VODACOM		  |Airtime	|29			|			|1950479609	  |Mar Properties CC	  |DocJ		|			|			          |No	  |Done		|
    |Matzume	    |0815793852	|TELKOM MOBILE		  |Airtime	|20		|			|			  |			  |Booking	|Fax		|0865948576			  |No	  |Done		|
