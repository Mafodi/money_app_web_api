...
public class FND_Transfer_From_Credit_To_Savings_Account extends DriverFactory {
    ...
    public void tcrs_userIsOnTheTransferScreenIosApp() throws Throwable {
        transferFlow.Navigate_To_Transfer_Screen();
    }

    @When("^TCrS_User enters amount to transfer ios app$")
    public void tcrs_userEntersAmountToTransferIosApp() throws InterruptedException {
        Thread.sleep(2000);
    ...
    public void tcrs_userSelectsFromAccountIosApp() throws InterruptedException {
    ...
    public void tcrs_userSelectsToAccountIosApp() {
    ...
    public void tcrs_userClickingOnNextShouldTakeUserToReviewTransferScreenIosApp() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public void tcrs_userShouldBeAbleToMakeTransferSuccessfullyIosApp() throws InterruptedException {
        Thread.sleep(2000);
