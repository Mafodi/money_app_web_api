@WebRegression
Feature: AuthOpt_In_Mode

  @Auth_Opt_In
  Scenario Outline: Verifying the functionality of Branch and ATM Locator in Authorized Opt In process
    ...
    Examples:
      ...
      | username | password      | Opening Hours Option | In Branch Services1    | In Branch Services2 | In Branch Services3| Features |Location name|Branch name|ATM Location name|
      | Praveen123 | Testing1!| Open Saturdays       | Account enquiry        |Teller               |Statements          |Deposit taking ATM |Johannesburg|Nedbank Braamfontein|Sandton          |


  @Morebranchinfo_Auth_Opt_In
  Scenario:Verifying the functionality of Morebranchinfo in Authorized Opt In process
    Given user launch Money App web application
    When Web user enter username "<username>" and password "<password>"
    And User clicks on Login button
    Then user must log on to Money Web application
  ...
  @Branch_Searchbar_Auth_Opt_In_Autosuggestion
  ...
  @Branch_Searchbar_Auth_Opt_In_Error
  ...
  @ATM_Searchbar_Auth_Opt_In_Autosuggestion
  ...
  @ATM_Searchbar_Auth_Opt_In_Error
  ...
  @Advancefilter_Auth_Opt_In_Remove_Tag
  ...
  @Advancefilter_Auth_Opt_In_Warning
  ...
  @Advancefilter_Auth_Opt_In_Error
  ...
  @Advancefilter_Auth_Opt_In_Clear_All_Filter
  Scenario Outline:Verifying the "X" tag functionality of Advance filter when user selects Service options in advance filter
    Given user launch Money App web application
    When Web user enter username "<username>" and password "<password>"
    And User clicks on Login button
