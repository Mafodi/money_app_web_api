@TransferMonthly @Transfer @FNDWebRegression2
Feature: Reccuring Transfer Monthly
...
|100|Tuesday, 31 December 2019| Monthly   |5    |
  ...
  Scenario Outline: Transfer from current to Investment Account
    ...
    Examples:
      ...
      |100|45431114-9969       |Tuesday, 31 December 2019|Monthly|5    |
  ...
  Scenario Outline: Transfer from current to Credit Account
    ...
    Examples:
      ...
      |100|377095404912201 |Tuesday, 31 December 2019|Monthly  |5    |
  ...
  Scenario Outline: Transfer from Savings to Investment Account
    ...
    Examples:
      ...
      |100|1310311100101     |Tuesday, 31 December 2019|Monthly  |5    |
