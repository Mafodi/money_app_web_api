Feature: CL_Weekly_E2E_Flow 
Description: CL_Weekly_E2E_Flow 

@CL_Weekly_E2E_MoreNotification_IOS @Regression_PL_IOS
Scenario Outline: CL_Weekly_E2E_Flow 
...
|CLOffer                                                                                                                                                                               |
|Test WKLY Pass:Consolidation loan. Up to R244 600.00 additional cash out on your existing Nedbank Personal loan. Money in your account with a few simple clicks. |
