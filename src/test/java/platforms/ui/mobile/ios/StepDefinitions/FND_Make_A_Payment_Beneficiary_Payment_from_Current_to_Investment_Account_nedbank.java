...
public class FND_Make_A_Payment_Beneficiary_Payment_from_Current_to_Investment_Account_nedbank extends DriverFactory {
    ...
    public FND_Make_A_Payment_Beneficiary_Payment_from_Current_to_Investment_Account_nedbank(){}

    @Given("^PEM_User_IV accesses Payment screen ios app$")
    public void pem_user_ivAccessesPaymentScreenIosApp() throws Throwable {
        paymentFlow.Navigate_To_Payment_Screen();
    }

    @When("^PEM_User_IV navigates to Single Payment screen ios app$")
    public void pem_user_ivNavigatesToSinglePaymentScreenIosApp() {
        payScreen.Transact_single_pay.click();
        log.info("single payment selected");
    }

    @And("^PEM_User_IV selects recipients icon ios app$")
    public void pem_user_ivSelectsRecipientsIconIosApp() {
        payScreen.Transact_Pay_Beneficiary_list_icon.click();
    }

    @And("^PEM_User_IV should be able to search \"([^\"]*)\" and select ios app$")
    public void pem_user_ivShouldBeAbleToSearchAndSelectIosApp(String recipientsname) throws Throwable {
        Thread.sleep(2000);
    ...
    public void pem_user_ivClickingOnNextShouldTakeMeToNextScreenIosApp() throws InterruptedException {
        paymentFlow.Process_Payment_to_Beneficiary();
    }

    @Then("^PEM_User_IV should be able to make payment successfully ios app$")
    public void pem_user_ivShouldBeAbleToMakePaymentSuccessfullyIosApp() {
