Feature: PL_E2E_Flow
Description: PL_E2E_Flow

@PL_E2E_MoreNotification_IOS @Regression_PL_IOS @Test_1
Scenario Outline: PL_E2E_Flow  
...
#nd User clicks on Authorize button on Debichek screen
