@notifications
Feature: RetrieveSNotificationResponse end point

  Background:
    * configure ssl = { keystore:'In-App-Notifications/certs/NedbankIssuingSHA2.cer' }
    * configure charset = null

  Scenario Outline: Testing the RetrieveSNotificationResponse end point with the correct inputs
    Given url InApp_BackOffice_BaseUrl
    And path 'notifications/<notificationId>/responses'
  ...
  Scenario Outline: Testing the RetrieveSNotifications end point with the incorrect Client-Secret-Id
    ...
    Examples:
      | ibmClientId                          | ibmClientSecret                                    | backOfficeToken                    | backOfficeId | notificationId |
      | 6aa93f2e-2d66-48dd-b2c6-b773f16283ac | X3yB3vD8rG6cT3gK7wK1jE6kL4lI0tG1fK2bR1hI5qN4qM0oK4 | 5ff8262a14794b03a2e11e75ae777db4-1 | Walter       | EMINotif9006   |
