Feature: Staff Consolidate Monthly with own insurance

  @PLStaffConOfferMNTHLYOwnInsurance @OwnInsurance
  Scenario Outline: as a user i want to take up an offer
    ...
    Examples:
      ...
      | GhostStaff26 | Testing123* | Test MNTHLY Pass:Consolidation loan. Up to R124 700.00 |     yes     |  yes    |         no             |Salary date   |45000                      |Furniture|glens@nedbank.co.za|