Feature: Staff Consolidate Monthly Bureau

  @PLStaffConOfferMNTHLYBureau @AllBureau
...
Then user sees the affordability screen
    ...
    Examples:
      ...
      | GhostStaff26 | Testing123* | Test MNTHLY Pass:Consolidation loan. Up to R124 700.00 |     yes     |  yes    |         yes             |Salary date   |45000                      |Furniture|glens@nedbank.co.za|