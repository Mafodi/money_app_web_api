Feature: Validate the AuthOpt_In_Mode flow scenarios
  ...
  @SQ_AuthOpt_In_Mode_NonQMatic @SQ_AuthOpt_In_Mode_All
  Scenario Outline: Verification of the complete end to end Opt In flow in authenticated mode
  ...
  @SQ_AuthOpt_In_Mode_QMatic @SQ_AuthOpt_In_Mode_All
  Scenario Outline: Verification of the complete end to end Opt In flow in authenticated mode for QMatics branches
    When user click on Menu footer
    When user navigates to Branch locator on android app
    And click on Next button on network permission screen
    Then Verify that list of ten closest active branches on the map should displayed on android app
  ...
  @SQ_AuthOpt_In_Mode_BranchDetails_NonQMatic @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_BranchDetails_QMatic @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_ATM @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_AdvancedFilterError @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_AutosuggestionCheck @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_BranchValidSearch @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_BranchInvalidSearch @SQ_AuthOpt_In_Mode_All
  Scenario Outline: Verification of invalid branch search flow and validating the error message with that respect in authenticated mode
    When user click on Menu footer
    When user navigates to Branch locator on android app
    And click on Next button on network permission screen
    Then Verify that list of ten closest active branches on the map should displayed on android app
  ...
  @SQ_AuthOpt_In_Mode_ATMValidSearch @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_BranchClearSearchButton @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_ClearFilter @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_MultiServiceFilter @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_MultiServiceFilterError  @SQ_AuthOpt_In_Mode_All
  ...
  @SQ_AuthOpt_In_Mode_MultiServiceFilterClearAll @SQ_AuthOpt_In_Mode_All
