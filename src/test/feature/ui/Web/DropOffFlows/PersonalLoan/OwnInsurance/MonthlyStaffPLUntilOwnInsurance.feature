Feature: Staff Personal Loan Monthly with own insurance

@PLStaffOfferMNTHLYOwnInsurance @OwnInsurance
...
| GhostStaff26 | Testing123* | Test MNTHLY Pass:Personal loan. Up to R250 000.00 |     yes     |  yes    |         no             |Salary date   |35000     |