Feature: Non Staff Consolidate Monthly with own insurance
  ...
  Scenario Outline: as a user i want to take up an offer
    ...
    Examples:
      ...
      | GhostCard2 | Testing123* | Test MNTHLY Pass:Consolidation loan. Up to R156 300.00 |     yes     |  no    |        no             |Salary date   |35000     |Furniture|glens@nedbank.co.za|
