...
public class FND_Make_A_Payment_Beneficiary_Payment_from_Savings_to_CreditCard_Account_nedbank extends DriverFactory {
    ...
    public FND_Make_A_Payment_Beneficiary_Payment_from_Savings_to_CreditCard_Account_nedbank(){}

    @Given("^PEM_User_CCR accesses Payments screen ios app$")
    public void pem_user_ccrAccessesPaymentsScreenIosApp() throws Throwable {
        paymentFlow.Navigate_To_Payment_Screen();
    }

    @When("^PEM_User_CCR navigates to Single Payments screen ios app$")
    public void pem_user_ccrNavigatesToSinglePaymentsScreenIosApp() {
        payScreen.Transact_single_pay.click();
        log.info("single payment selected");
    }

    @And("^PEM_Click_CCR selects recipients icon ios app$")
    public void pem_click_ccrSelectsRecipientsIconIosApp() {
        payScreen.Transact_Pay_Beneficiary_list_icon.click();
    }

    @And("^PEM_Click_CCR should be able to search \"([^\"]*)\" and select ios app$")
    public void pem_click_ccrShouldBeAbleToSearchAndSelectIosApp(String recipientsname) throws Throwable {
        Thread.sleep(2000);
    ...
    public void pem_click_ccrClickingOnNextShouldTakeMeToNextScreenIosApp() throws InterruptedException {
        paymentFlow.Process_Payment_to_Beneficiary();
    }

    @And("^PEM_Click_CCR should be able to make payment successfully ios app$")
    public void pem_click_ccrShouldBeAbleToMakePaymentSuccessfullyIosApp() {
