...
public class FND_Transfer_From_Credit_To_Credit_Account extends DriverFactory {
    ...
    public void tcrcr_userIsOnTheTransferScreenIosApp() throws Throwable {
        transferFlow.Navigate_To_Transfer_Screen();
    }

    @When("^TCrCr_User enters amount to transfer ios app$")
    public void tcrcr_userEntersAmountToTransferIosApp() throws InterruptedException {
        Thread.sleep(2000);
    ...
    public void tcrcr_userSelectsFromAccountIosApp() throws InterruptedException {
    ...
    public void tcrcr_userSelectsToAccountIosApp() {
    ...
    public void tcrcr_userClickingOnNextShouldTakeUserToReviewTransferScreenIosApp() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public void tcrcr_userShouldBeAbleToMakeTransferSuccessfullyIosApp() throws InterruptedException {
        Thread.sleep(2000);
