Feature: CL_Staff_E2E_Flow 
Description: CL_Staff_E2E_Flow  

@CL_Staff_E2E_MoreNotification_IOS @Regression_PL_IOS
Scenario Outline: CL_Staff_E2E_Flow 
...
|CLOffer                                                                                                                                                                               |
|Test MNTHLY Pass:Consolidation loan. Up to R173 700.00 additional cash out on your existing Nedbank Personal loan. Money in your account with a few simple clicks. |
