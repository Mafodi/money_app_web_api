Feature: Non Staff Consolidate Weekly Bureau

  @PLConOfferWKLYBureau @AllBureau
...
Then user sees the affordability screen
    ...
    Examples:
      ...
      | GhostCard2 | Testing123* | Test WKLY Pass:Consolidation loan. Up to R245 600.00 |     yes     |  no    |        yes             |Salary date   |35000    |
