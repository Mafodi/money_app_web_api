...
public class FND_Make_A_Payment_Beneficiary_Payment_from_Current_to_Savings_Account_nedbank extends DriverFactory {
    ...
    public FND_Make_A_Payment_Beneficiary_Payment_from_Current_to_Savings_Account_nedbank(){}

    @Given("^PEM_User_SA accesses Payments screen ios app$")
    public void pem_user_saAccessesPaymentsScreenIosApp() throws Throwable {
        paymentFlow.Navigate_To_Payment_Screen();
    }

    @When("^PEM_User_SA navigates to Single payment screen ios app$")
    public void pem_user_saNavigatesToSinglePaymentScreenIosApp() {
        payScreen.Transact_single_pay.click();
        log.info("single payment selected");
    }

    @And("^PEM_Click_SA selects recipients icon ios app$")
    public void pem_click_saSelectsRecipientsIconIosApp() {
        payScreen.Transact_Pay_Beneficiary_list_icon.click();
    }

    @And("^PEM_Click_SA should be able to search \"([^\"]*)\" and select ios app$")
    public void pem_click_saShouldBeAbleToSearchAndSelectIosApp(String recipientsname ) throws Throwable {
        Thread.sleep(2000);
    ...
    public void pem_click_saClickingOnNextShouldTakeMeToNextScreenIosApp() throws InterruptedException {
        paymentFlow.Process_Payment_to_Beneficiary();
    }

    @And("^PEM_Click_SA should be able to make payment successfully ios app$")
    public void pem_click_saShouldBeAbleToMakePaymentSuccessfullyIosApp() {
