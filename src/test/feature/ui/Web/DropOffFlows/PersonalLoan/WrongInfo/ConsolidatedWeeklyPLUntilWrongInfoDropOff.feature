Feature: Non Staff Consolidate Weekly with wrong infomation

  @PLConOfferWKLYWrongInfo @WrongInfo
  Scenario Outline: as a user i want to take up an offer
    ...
    Examples:
      ...
      | GhostCard2 | Testing123* | Test WKLY Pass:Consolidation loan. Up to R245 600.00 |     yes     |monthly income |
