Feature: Staff Personal Loan Monthly with wrong infomation

@PLStaffOfferMNTHLYWrongInfo @WrongInfo
...
| GhostStaff26 | Testing123* | Test MNTHLY Pass:Personal loan. Up to R250 000.00 |     no     | monthly income |