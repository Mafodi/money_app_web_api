Feature: Staff Consolidate Monthly with wrong infomation

  @PLStaffConOfferMNTHLYWrongInfo @WrongInfo
  Scenario Outline: as a user i want to take up an offer
    ...
    Examples:
      ...
      | GhostStaff26 | Testing123* | Test MNTHLY Pass:Consolidation loan. Up to R124 700.00 |     yes     |monthly income |