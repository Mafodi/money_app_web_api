...
//        json.addProperty("tool_version", "1.10.0");
//        json.addProperty("environment", "QA");
        json.addProperty("project", "MoneyApp");
    ...
    public static RestClient kibanaConnection(){
        try {
            RestClient restClient = RestClient.builder(
                    new HttpHost("xqaeqasel1.node.test.dfl.nednet.co.za", 9200, "http"),
                    new HttpHost("xqaeqasel1.node.test.dfl.nednet.co.za", 9205, "http")).build();
            return restClient;
        } catch(Exception e){
            //logger
            return null;
