Feature: Non Staff Personal Loan Weekly with own insurance

@PLOfferWKLYOwnInsurance @OwnInsurance
...
| GhostCard2 | Testing123* | Test WKLY Pass:Personal loan. Up to R182 800.00 |     yes     |  no    |        no             |Salary date   |35000    |
